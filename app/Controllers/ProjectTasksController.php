...
class ProjectTasksController extends AbstractControllers {
    ...
    public function getCarById(){
        ...
        $databaseConnection = DatabaseConnection::start()->getPDO();
        $reqCar = $databaseConnection->query(
                "SELECT * FROM car WHERE car.id_car = '{$valueOfVariable}';"
        )->fetchAll();
    ...
    public function getCarByname(){
        ...
        $databaseConnection = DatabaseConnection::start()->getPDO();
        $reqCar = $databaseConnection->query(
                "SELECT * FROM car WHERE car.name = '{$valueOfVariable}';"
        )->fetchAll();
    ...
    public function getSellers(){
        $databaseConnection = DatabaseConnection::start()->getPDO();
        $reqSeller = $databaseConnection->query(
                "SELECT * FROM seller;"
        )->fetchAll();
        view($reqSeller);
    }
    ...
    public function getSellerById(){
        ...
        $databaseConnection = DatabaseConnection::start()->getPDO();
        $reqSeller = $databaseConnection->query(
                "SELECT * FROM seller WHERE seller.id_seller = '{$valueOfVariable}';"
        )->fetchAll();     
        view($reqSeller);
    }
    ...
    public function getSellerByName(){
        ...
        $databaseConnection = DatabaseConnection::start()->getPDO();
        $reqSeller = $databaseConnection->query(
                "SELECT * FROM seller WHERE seller.name = '{$valueOfVariable}';"
        )->fetchAll();        
    ...
    public function getSellByName(){
        ...
        $reqSell = $databaseConnection->query(
                "SELECT * FROM car WHERE car.id_car IN (SELECT sells.id_car FROM sells WHERE sells.id_seller = (SELECT seller.id_seller FROM seller WHERE seller.name = '{$valueOfVariable}'));"
        )->fetchAll();
    ...
    public function getBuyers(){
        ...
        $databaseConnection = DatabaseConnection::start()->getPDO();
        $reqBuyer = $databaseConnection->query(
                "SELECT * FROM buyer;"
         )->fetchAll();
    ...
    public function getBuyersById(){
        ...
        $databaseConnection = DatabaseConnection::start()->getPDO();
        $reqBuyer = $databaseConnection->query(
                "SELECT * FROM buyer WHERE buyer.id_buyer = '{$valueOfVariable}';"
        )->fetchAll();       
    ...
    public function getBuyerByName(){
        ...
        $databaseConnection = DatabaseConnection::start()->getPDO();
        $reqBuyer = $databaseConnection->query(
                "SELECT name, last_name FROM buyer WHERE buyer.name = '{$valueOfVariable}';"
        )->fetchAll();        
    ...
    public function getCarsByBuyerName(){
        ...
        $reqCars = $databaseConnection->query(
                "SELECT * FROM car WHERE car.id_car IN (SELECT sells.id_car FROM sells WHERE sells.id_buyer = (SELECT buyer.id_buyer FROM buyer WHERE buyer.name = '{$valueOfVariable}'));"
        )->fetchAll();
